...
filtlong --min_mean_q 90 "$inputdir/barcode01_decontaminated.fastq.gz" | gzip > "$outdir/q90/barcode01_filtered.fastq.gz"
filtlong --min_mean_q 90 "$inputdir/barcode03_decontaminated.fastq.gz" | gzip > "$outdir/q90/barcode03_filtered.fastq.gz"
filtlong --min_mean_q 90 "$inputdir/blo_decontaminated.fastq.gz"       | gzip > "$outdir/q90/blo_filtered.fastq.gz"
